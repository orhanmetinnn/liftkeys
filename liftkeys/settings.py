...
DEBUG = False  # Canlı sunucuda False yapmayı unutma
...
# === WAGTAIL CACHE EXCLUDE PATHS ===
# Dil yönlendirmesinin (Accept-Language / Cookie) cache'lenmesini önlemek için kök dizini hariç tutuyoruz.
WAGTAIL_CACHE_EXCLUDE_PATHS = [
    r'^/$',
]
